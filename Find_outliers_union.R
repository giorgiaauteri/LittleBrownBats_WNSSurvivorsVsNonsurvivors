...
sel3 <- read.csv("SelectedLoci_OutFlank.csv")
...
write.csv(final,  
           quote = FALSE,
          row.names = FALSE,
           file="SelectedLoci_PreIDs.csv")
##General candidates 
write.csv(generalCandidates,  
          quote = FALSE,
          row.names = FALSE,
          file="LociOfInterest_PreIDs.csv")
